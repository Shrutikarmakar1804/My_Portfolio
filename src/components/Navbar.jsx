        ...
        <div className="hidden md:flex items-center gap-8">
          {navItems.map((item, index) => (
            <a
              key={index}
              href={item.href}
              className="relative group text-base font-semibold text-foreground/90 hover:text-primary transition-colors duration-300 px-2 py-1"
            >
              {item.name}
        ...
        >
          ...
          {navItems.map((item, index) => (
            <a
              ...
              href={item.href}
              onClick={() => setIsMenuOpen(false)}
              className="text-3xl font-extrabold text-foreground/90 hover:text-primary transition-colors duration-300 tracking-wide"
            >
              {item.name}
            </a>
          ))}
